...
_T: dict[str, dict[str, str]] = {
    ...
    "sd.vnc.novnc":      {"it": "noVNC integrato (WebKit)",   "en": "Embedded noVNC (WebKit)",  "de": "Eingebettetes noVNC",      "fr": "noVNC intégré (WebKit)",   "es": "noVNC integrado (WebKit)"},
    # VNC color depth
...
# ── Gestione Cifratura (Dialog) ──────────────────────────────
    ...
    "tt.vnc_mode":    {"it": "Come aprire la sessione VNC:\n• Client esterno — usa il client VNC installato nel sistema\n• noVNC integrato — viewer HTML5 embedded nel pannello", "en": "How to open the VNC session:\n• External client — uses the VNC client installed on the system\n• Integrated noVNC — HTML5 viewer embedded in the panel", "de": "VNC-Sitzung öffnen:\n• Externer Client — nutzt den installierten VNC-Client\n• Integriertes noVNC — HTML5-Viewer im Panel", "fr": "Comment ouvrir la session VNC :\n• Client externe — utilise le client VNC installé sur le système\n• noVNC intégré — visionneuse HTML5 intégrée dans le panneau", "es": "Cómo abrir la sesión VNC:\n• Cliente externo — usa el cliente VNC instalado en el sistema\n• noVNC integrado — visor HTML5 integrado en el panel"},
