...
_T: dict[str, dict[str, str]] = {
    ...
    "winscp.tooltip_delete_remote":{"it":"Elimina gli elementi selezionati sul remoto", "en": "Delete selected items on remote", "de": "Ausgewählte Elemente auf dem Remote löschen", "fr": "Supprimer les éléments sélectionnés à distance", "es": "Eliminar elementos seleccionados en remoto"},
